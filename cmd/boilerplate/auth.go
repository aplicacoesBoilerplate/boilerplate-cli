...
var authCmd = &cobra.Command{
	Use:   "auth",
	Short: "Gerencia autenticação para GitHub Packages",
}

var authLoginCmd = &cobra.Command{
	Use:   "login",
	Short: "Lê token de gh auth token e escreve ~/.m2/settings.xml e ~/.npmrc",
...
var authStatusCmd = &cobra.Command{
	Use:   "status",
	Short: "Valida credenciais (gh api /user e teste de resolução)",
	RunE: func(cmd *cobra.Command, args []string) error {
